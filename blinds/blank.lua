...
function tw_blind:set_blind(reset, silent)
    ...
    for _, v in ipairs(G.jokers.cards) do
        if pseudorandom(pseudoseed('twbl_blank')) < G.GAME.probabilities.normal / (G.GAME.blind.config.extra and G.GAME.blind.config.extra.odds or G.GAME.blind.config.blind.config.extra.odds) then
